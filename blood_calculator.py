...
def driver():
    ...
    output_result(HDL_number,answerHDL,LDL_number,answerLDL,TC_number,answerTC)

def output_result(HDL_number,answerHDL,LDL_number,answerLDL,TC_number,answerTC):
